...
notebookObserver.observe(
  notebookElement.parentNode.parentNode.parentNode,
  config
);
...
defaultObserver.observe(
  defaultElement.parentNode.parentNode.parentNode,
  config
);
...
var buttonsInChat = document.querySelectorAll(
  "#chat-tab:not(.old-ui) #chat-buttons button"
);
...
if (buttonsInChat.length > 0) {
  ...
  buttonsInChat = document.querySelectorAll(
    "#chat-tab.old-ui #chat-buttons button"
  );
